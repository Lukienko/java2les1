...
public class Main {
    public static void main(String[] args) {
        ...
        actions[0] = new Human("Владимир", distance, heigth);

        distance = rand.nextInt(10);
        heigth = rand.nextInt(10);
        actions[1] = new Robot("Валли", distance, heigth);
        ...
        for (int i = 0; i < barriers.length; i++) {
            ...
            if (isRoad) {
                barriers[i] = new Maraphon("Road " + i, distance);
            } else {
        ...
        for (int i = 0; i < actions.length; i++) {
            ...
            if (result) {
                ...
                System.out.println("Постигла неудача(!");
                System.out.println("*****************");
            }
        }
    }
